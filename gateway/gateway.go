...
func (gateway *HandleT) StartWebHandler() {
	...
	srvMux.HandleFunc("/v1/i", gateway.stat(gateway.webIdentifyHandler))
	srvMux.HandleFunc("/v1/track", gateway.stat(gateway.webTrackHandler))
	srvMux.HandleFunc("/v1/t", gateway.stat(gateway.webTrackHandler))
	srvMux.HandleFunc("/v1/page", gateway.stat(gateway.webPageHandler))
	srvMux.HandleFunc("/v1/p", gateway.stat(gateway.webPageHandler))
	...
	srvMux.HandleFunc("/v1/a", gateway.stat(gateway.webAliasHandler))
	...
	srvMux.HandleFunc("/v1/g", gateway.stat(gateway.webGroupHandler))
